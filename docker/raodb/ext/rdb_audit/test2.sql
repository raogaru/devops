...
-- Create rdb_audit extension
CREATE EXTENSION IF NOT EXISTS rdb_audit;

-- Grant all on public schema to public
GRANT ALL ON SCHEMA public TO public;

-- Make sure events don't get logged twice when session logging
SET rdb_audit.log = 'all';
SET rdb_audit.log_client = ON;
SET rdb_audit.log_level = 'notice';
...
RESET rdb_audit.log_client;

DROP TABLE tmp;
DROP TABLE tmp2;

RESET rdb_audit.log;
RESET rdb_audit.log_level;
...
--
-- Set rdb_audit parameters for the current (super)user.
ALTER ROLE :"current_user" SET rdb_audit.log = 'Role';
ALTER ROLE :"current_user" SET rdb_audit.log_level = 'notice';
ALTER ROLE :"current_user" SET rdb_audit.log_client = ON;
...
ALTER ROLE regress_user1 SET rdb_audit.log = 'ddl, ROLE';
ALTER ROLE regress_user1 SET rdb_audit.log_level = 'notice';
...
ALTER ROLE regress_user1 SET rdb_audit.log_client = ON;
...
ALTER ROLE regress_user2 SET rdb_audit.log = 'Read, writE';
ALTER ROLE regress_user2 SET rdb_audit.log_catalog = OFF;
ALTER ROLE regress_user2 SET rdb_audit.log_client = ON;
ALTER ROLE regress_user2 SET rdb_audit.log_level = 'warning';
ALTER ROLE regress_user2 SET rdb_audit.role = regress_auditor;
ALTER ROLE regress_user2 SET rdb_audit.log_statement_once = ON;
...
\connect - :current_user
ALTER ROLE regress_user2 SET rdb_audit.log = 'NONE';
...
--
-- Confirm that "long" parameter values will not be logged if rdb_audit.log_parameter_max_size
-- is set.
\connect - :current_user
ALTER ROLE regress_user2 SET rdb_audit.log_parameter_max_size = 50;
ALTER ROLE regress_user2 SET rdb_audit.log_parameter = 'on';
...
\connect - :current_user
ALTER ROLE regress_user2 RESET rdb_audit.log_parameter_max_size;
...
\connect - :current_user
ALTER ROLE regress_user2 RESET rdb_audit.log_parameter;
...
ALTER ROLE regress_user1 SET rdb_audit.log = 'DDL, READ';
\connect - regress_user1
...
\connect - :current_user
ALTER ROLE regress_user1 SET rdb_audit.log = 'none';
ALTER ROLE regress_user1 SET rdb_audit.role = 'regress_auditor';
\connect - regress_user1
...
\connect - :current_user
ALTER ROLE regress_user1 SET rdb_audit.log_relation = on;
ALTER ROLE regress_user1 SET rdb_audit.log = 'read, WRITE';
\connect - regress_user1
...
\connect - :current_user
ALTER ROLE regress_user1 RESET rdb_audit.log_relation;
ALTER ROLE regress_user1 RESET rdb_audit.log;
ALTER ROLE regress_user1 SET rdb_audit.log_statement = OFF;
\connect - regress_user1
...
SET rdb_audit.log_level = 'notice';
SET rdb_audit.log_client = ON;
SET rdb_audit.log_relation = ON;
SET rdb_audit.log_parameter = ON;
...
CREATE DATABASE contrib_regression_rdb_audit;
ALTER DATABASE contrib_regression_rdb_audit RENAME TO contrib_regression_rdb_audit2;
DROP DATABASE contrib_regression_rdb_audit2;

-- Test role as a substmt
SET rdb_audit.log = 'ROLE';
...
SET rdb_audit.log = 'write';
SET rdb_audit.role = 'regress_auditor';
...
SET rdb_audit.log = 'READ,WRITE';
SET rdb_audit.role TO 'regress_auditor';
...
SET rdb_audit.log_parameter TO OFF;
INSERT INTO bbb VALUES (1);
SET rdb_audit.log_parameter TO ON;

DROP TABLE bbb;
DROP TABLE aaa;

-- Test create table as after extension as been dropped
DROP EXTENSION rdb_audit;
...
SET rdb_audit.log = 'ALL, -MISC, MISC_SET';
...
SET rdb_audit.log_client = on;
SET rdb_audit.log_relation = on;
SET rdb_audit.log_statement_once = off;
SET rdb_audit.log_parameter = on;
SET rdb_audit.log_rows = on;
...
ALTER ROLE regress_user1 RESET rdb_audit.log;
ALTER ROLE regress_user1 SET rdb_audit.log_statement = OFF;
ALTER ROLE regress_user1 SET rdb_audit.log_rows = on;
\connect - regress_user1
...
--
-- Test that rdb_audit event triggers are immune to search-path-based attacks
...
-- levels like notice
SET rdb_audit.log = 'all,-misc_set';
SET rdb_audit.log_level = 'warning';
...
ALTER ROLE :"current_user" RESET rdb_audit.log;
ALTER ROLE :"current_user" RESET rdb_audit.log_catalog;
ALTER ROLE :"current_user" RESET rdb_audit.log_client;
ALTER ROLE :"current_user" RESET rdb_audit.log_level;
ALTER ROLE :"current_user" RESET rdb_audit.log_parameter;
ALTER ROLE :"current_user" RESET rdb_audit.log_parameter_max_size;
ALTER ROLE :"current_user" RESET rdb_audit.log_relation;
ALTER ROLE :"current_user" RESET rdb_audit.log_statement;
ALTER ROLE :"current_user" RESET rdb_audit.log_statement_once;
ALTER ROLE :"current_user" RESET rdb_audit.role;

RESET rdb_audit.log;
RESET rdb_audit.log_catalog;
RESET rdb_audit.log_level;
RESET rdb_audit.log_parameter;
RESET rdb_audit.log_parameter_max_size;
RESET rdb_audit.log_relation;
RESET rdb_audit.log_statement;
RESET rdb_audit.log_statement_once;
RESET rdb_audit.role;
