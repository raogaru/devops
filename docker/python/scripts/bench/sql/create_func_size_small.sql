...
CREATE OR REPLACE FUNCTION bench.f_t_small4(p_id bigint)
...
CREATE OR REPLACE FUNCTION bench.f_t_small5(p_id bigint)
...
CREATE OR REPLACE FUNCTION bench.f_t_small6(p_id bigint)
...
CREATE OR REPLACE FUNCTION bench.f_t_small7(p_id bigint)
...
CREATE OR REPLACE FUNCTION bench.f_t_small8(p_id bigint)
...
CREATE OR REPLACE FUNCTION bench.f_t_small9(p_id bigint)
...
CREATE OR REPLACE FUNCTION bench.f_t_small10(p_id bigint)
