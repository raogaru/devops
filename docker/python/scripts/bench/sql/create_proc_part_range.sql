...
CREATE OR REPLACE PROCEDURE bench.p_t_range4(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE bench.p_t_range5(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE bench.p_t_range6(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE bench.p_t_range7(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE bench.p_t_range8(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE bench.p_t_range9(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE bench.p_t_range10(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
