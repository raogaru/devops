...
CREATE OR REPLACE PROCEDURE bench.p_t_large4(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE bench.p_t_large5(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE bench.p_t_large6(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE bench.p_t_large7(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE bench.p_t_large8(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE bench.p_t_large9(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE bench.p_t_large10(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
