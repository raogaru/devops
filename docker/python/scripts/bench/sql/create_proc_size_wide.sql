...
CREATE OR REPLACE PROCEDURE bench.p_t_wide4(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE bench.p_t_wide5(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE bench.p_t_wide6(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE bench.p_t_wide7(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE bench.p_t_wide8(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE bench.p_t_wide9(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE bench.p_t_wide10(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
