...
CREATE OR REPLACE PROCEDURE bench.p_t_small4(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE bench.p_t_small5(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE bench.p_t_small6(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE bench.p_t_small7(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE bench.p_t_small8(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE bench.p_t_small9(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE bench.p_t_small10(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
