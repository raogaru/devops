...
CREATE OR REPLACE PROCEDURE bench.p_t_medium4(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE bench.p_t_medium5(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE bench.p_t_medium6(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE bench.p_t_medium7(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE bench.p_t_medium8(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE bench.p_t_medium9(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE bench.p_t_medium10(INOUT p_refcur REFCURSOR,IN p_id bigint)
LANGUAGE plpgsql AS $$
BEGIN
