...
def run_group(dsn, group, defaults, execution_cfg):
    ...
    for iteration in range(1, repeat + 1):
        ...
        print(f"    group:{group['name']} iteration:{iteration}/{repeat} start_time: {group_start_time}")
        ...
        try:
            ...
            print(f"    group:{group['name']} iteration:{iteration}/{repeat} end_time: {group_end_time}")
            print(f"    group:{group['name']} iteration:{iteration}/{repeat} duration: {group_duration:.2f}s")
